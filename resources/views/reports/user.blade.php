        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3" for="name">Full Name</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3" for="service_no">Service No</label>
                        <div class="col-sm-9">
                            <span>{{$user->service_no}}</span>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3" for="rank">Rank</label>
                        <div class="col-sm-9">
                            <span>{{$user->rank}}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3" for="regiment">Regiment</label>
                        <div class="col-sm-9">
                            <span>{{$user->regiment}}</span>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3" for="unit">Unit</label>
                        <div class="col-sm-9">
                            <span>{{$user->unit}}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3" for="assigned_date">Assigned Date</label>
                        <div class="col-sm-9">
                            <span>{{$user->assigned_date}}</span>
                        </div>
                    </div>
