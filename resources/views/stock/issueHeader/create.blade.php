        ...
        <div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Add Issue Note</div>
                ...
                <form role="form" method="POST" action="{{ route('issueHeader.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="no"
                                       ...
                                       placeholder="Issue Order No" value="{{ old('no') }}">
                                @error('no')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="service_no"
                                       ...
                                       placeholder="Service No" value="{{ old('service_no') }}">
                                @error('service_no')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
@section('third_party_scripts')
    ...
    <script>
        ...
        $('#remarks').ready(function () {
            ...
            $('#remarks').val("Issue to " + newDate.toLocaleString() + " for ");
        })
