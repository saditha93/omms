    ...
    <div class="container-fluid">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>GRN and GIN Details for a item</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item ">Reports</li>
                            <li class="breadcrumb-item active">GRN and GIN Details for a item</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">GRN and GIN Details for a item</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 overflow-x-auto relative shadow-md sm:rounded-lg">
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (key, value) {
                            $('#in').append("<tr><th class='py-4 px-6'>" + value.header.no + "</th>\
										<th class='py-4 px-6'>" + value.header.date + "</th>\
										<th class='py-4 px-6'>" + value.header.service_no + "</th>\
										<th class='py-4 px-6'>" + value.qty + "</th>\
										");
                        })
                    }
