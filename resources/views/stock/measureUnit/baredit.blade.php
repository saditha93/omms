        ...
        <div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Edit {{ $measureUnit->name }}</div>
                ...
                <form role="form" method="POST" action="{{ route('measureUnit.update',$measureUnit->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name"
                                       ...
                                       placeholder="Name" value="{{ $measureUnit->name }}">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="abbreviation"
                                       ...
                                       id="abbreviation"
                                       placeholder="Abbreviation" value="{{ $measureUnit->abbreviation }}">
                                @error('abbreviation')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3" for="size">If Size</label>
                            <div class="col-sm-4">
                                <input type="text" name="size"
                                       class="form-control   @error('size') is-invalid @enderror"
                                       id="size"
                                       placeholder="Size" value="{{ $measureUnit->size }}">
                                @error('size')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-5">
                                <select id="size_type" name="size_type"
                                    ...
                                    <option @selected($measureUnit->size_type == 'n') value="n">Non</option>
                                    <option @selected($measureUnit->size_type == 'ml') value="ml">ML</option>
                                    <option @selected($measureUnit->size_type == 'g') value="g">G</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <select required multiple id="category_id" name="category_ids[]"
                                    ...
                                    @foreach($categories as $item)
                                        <option
                                            @selected(isset($measureUnit->categories()->where('id',$item->id)->first()->id)) value="{{$item->id}}">{{$item->name}}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select required name="establishment_id" id="establishment_id"
                                        ...
                                        @if(isset($measureUnit->establishment->id))
                                            @foreach($establisments as $establisment)
                                                <option
                                                    @selected($measureUnit->establishment->id == $establisment->id)  value="{{$establisment->id}}">{{$establisment->name}}</option>
                                            @endforeach
                                        @else
