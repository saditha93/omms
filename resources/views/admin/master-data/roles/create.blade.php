                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="module_type" id="module_type" class="form-control">
                                <option value="Demand-Management-Module">Demand Management Module</option>
                                <option value="Stock-Management-Module">Stock Management Module</option>
                                <option value="Bar-Management-Module">Bar Management Module</option>
                                <option value="Bill Management Module">Bill Management Module Module</option>
                            </select>
                            @error('module_type')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group mt-5">
                            ...
                            {{--Ration--}}
                            <div class="row mb-2 text-maroon"><label>Demand Management Module</label></div>
                            <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button type="submit" class="btn btn-primary float-right btn-sm bg-dark">Submit</button>
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
