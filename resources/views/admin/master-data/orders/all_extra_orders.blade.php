    ...
    <div class="col-md-12 pt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="allExtraTbl" class="display" style="width:100%">
                    <thead>
                    <tr>
                        <th>Index</th>
                        <th>Officer Name</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            {
                //dtaTable
                $('#allExtraTbl').DataTable({
                    // responsive: true,
                    // processing: true,
                    serverSide: true,
                    ajax: {
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        url: '{{url("admin/get-all-extra")}}',
                        type: "POST",
...
@push('page_css')
    <style>
        #allExtraTbl_wrapper .dt-buttons{
