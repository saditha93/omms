    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#dateFilter', function (e) {
                ...
                $('#allDessertTbl').DataTable().destroy();
                tea(fromDate,toDate);
            });
                    ...
                    columns: [
                        ...
                        {data: 'item_name', name: 'item_name'},
                        {
                            "mRender": function (data, group, full, meta) {
                                ...
                                let mealTime = '';
                                if(full.meal_time==1){mealTime = "Breakfast"}
                                if(full.meal_time==2){mealTime = "Lunch"}
                                if(full.meal_time==3){mealTime = "Dinner"}
