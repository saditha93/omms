    ...
    <div class="col-md-12 pt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="allOtherOrderTbl" class="display" style="width:100%">
                    <thead>
                    <tr>
                        <th>Index</th>
                        <th>Officer Name</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            otherOrder($('#fromDate').val(),$('#toDate').val());
            ...
            $(document).on('click', '#dateFilter', function (e) {
                ...
                $('#allOtherOrderTbl').DataTable().destroy();
                otherOrder(fromDate,toDate);
            });

            function otherOrder(fromDate='',toDate='')
            {
                //dtaTable
                $('#allOtherOrderTbl').DataTable({
                    // responsive: true,
                    // processing: true,
                    serverSide: true,
                    ajax: {
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        url: '{{url("admin/get-all-other-order")}}',
                        type: "POST",
                    ...
                    columns: [
                        ...
                        {data: 'order_other', name: 'order_other'},
...
@push('page_css')
    <style>
        #allOtherOrderTbl_wrapper .dt-buttons{
