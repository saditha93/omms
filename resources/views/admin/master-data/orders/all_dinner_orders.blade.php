    ...
    <div class="col-md-12 pt-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="allDinnerTbl" class="display" style="width:100%">
                    <thead>
                    <tr>
                        <th>Index</th>
                        <th>Officer Name</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            dinner($('#fromDate').val(),$('#toDate').val());
            ...
            $(document).on('click', '#dateFilter', function (e) {
                ...
                $('#allDinnerTbl').DataTable().destroy();
                dinner(fromDate,toDate);
            });

            function dinner(fromDate='',toDate='')
            {
                //dtaTable
                $('#allDinnerTbl').DataTable({
                    // responsive: true,
                    // processing: true,
                    serverSide: true,
                    ajax: {
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        url: '{{url("admin/get-all-dinner")}}',
                        type: "POST",
                    ...
                    columns: [
                        ...
                        {data: 'order_dinner', name: 'order_dinner'},
...
@push('page_css')
    <style>
        #allDinnerTbl_wrapper .dt-buttons{
