    ...
    return (() => {
        ...
        var e = {
            422: (e, t, n) => {
                ...
                var i = "show-calendar", o = "hide-calendar", l = "update-calendar", d = "update-display",
                    s = "update-header", u = "update-preview", v = "date-pick", m = "preview-pick", f = "month-change",
                    h = "year-change", p = "set-date", y = "cancel-calendar", g = function (e) {
                ...
                var E = function (e, t, n) {
                    ...
                    return {
                        slide: function (t, n, a) {
                            ...
                            t.classList.add(r), n.classList.add(c), e = L(150).then((function () {
                    ...
                    if (W(e).date() && $(r.toLocaleLowerCase()).isValid()) {
                        var c = e.getDay(), i = e.getDate(), o = e.getMonth(), l = e.getFullYear(), d = {
                            d: String(i),
                    ...
                    var n = function (e, t) {
                            var n = window.innerWidth, a = window.innerHeight, r = document.body.offsetHeight, c = S(t),
                                i = S(e);
                            return {
                                vw: n,
                                vh: a,
                        ...
                        }(e, t), a = n.cal, r = n.elem, c = n.vw, i = n.vh, o = n.dh, l = n.elementOffsetTop,
                        d = n.elementOffsetleft, s = function (e) {
                        ...
                        }(n), v = s.l > 0, m = c > s.r, f = s.t > 0, h = i > s.b, p = u.t > 0, y = o > u.b, g = null,
                        b = null;
                    ...
                    return {
                        ...
                        close: function () {
                            var t = this;
                            this.closed || this.isOpening || this.isClosing || (r = !1, this.isClosing = !0, clearTimeout(n), e.dispatchEvent(new CustomEvent(o, {bubbles: !0})), n = setTimeout((function () {
                                t.isClosing = !1, t.opened = !1, t.closed = !0
                            }), 200))
                        },
                        blur: function () {
                            var e = this;
                            return this.isBluring = !0, L(100).then((function () {
                ...
                var W = function (e) {
                    ...
                    theme_color: function (e) {
                        ...
                        var t = z(["active", "inactive", "marcked"], e), n = Object.keys(e).every((function (t) {
                            var n = e[t], a = z(["default", "picked", "today"], n);
                        ...
                        var t = z(["active", "inactive"], e), n = Object.keys(e).every((function (t) {
                            var n = e[t], a = z(["default", "picked"], n), r = Object.keys(n).every((function (e) {
                                return J("default" === e ? ["foreground"] : ["foreground", "background"], n[e])
                            }));
                            return a && r
                        }));
                    ...
                    var n = e.options, a = e.pickedDate, r = new Date(t.getFullYear(), t.getMonth(), 1),
                        c = r.getMonth(), i = function (t) {
                            ...
                            return t.ariaLabel = t.date.toDateString(), !function (e, t) {
                                ...
                                var n = e.prevLimitDate, a = e.nextLimitDate, r = t.date, c = !!n && O(r) < O(n),
                                    i = !!a && O(a) < O(r);
                                return c || i
                            }(e, t) || function (e, t) {
                            ...
                            }(n, t) ? (r.push("mc-date--inactive"), t.tabindex = -1) : (r.push("mc-date--active"), t.tabindex = 0), function (e, t) {
                                var n = t.date;
                                return null !== e && O(e) === O(n)
                            }(a, t) && (r.push("mc-date--picked"), t.ariaLabel = "Picked: ".concat(t.ariaLabel)), function (e, t) {
                                ...
                                return c || i
                            }(e, t) && (r.push("mc-date--marked"), t.ariaLabel = "Marked: ".concat(t.ariaLabel)), function (e) {
                                var t = e.date;
                ...
                function oe(e) {
                    ...
                    var n = se(t);
                    return function (e) {
                        var t = null, n = !0, a = e.calendarStates, r = e.calendar, c = e.calendarDisplay,
                            g = e.calendarPicker, b = e.calendarHeader, x = e.currentMonthSelect,
                            E = e.currentYearSelect, L = e.monthYearPreview, T = e.monthNavPrev, O = e.monthNavNext,
                            S = e.yearNavPrev, Y = e.yearNavNext, j = e.dateCells, N = e.previewCells,
                            A = e.cancelButton, P = e.okButton, F = e.clearButton;
                        r.addEventListener(i, (function (n) {
                            t = n.detail.instance, xe(e, t), r.classList.add("mc-calendar--opened"), t.onOpenCallbacks.forEach((function (e) {
                                return e.apply(null)
                            }))
                        })), r.addEventListener(o, (function () {
                            var e = t, n = e.options, a = e.onCloseCallbacks;
                            ...
                            if (t) {
                                var n = e.detail, r = n.data, c = n.dblclick, i = t, o = i.store, l = i.options,
                                    d = i.viewLayers, s = l.customMonths, u = l.autoClose, v = l.closeOndblclick,
                                    m = o.preview.target;
                                if (!e.target.classList.contains("mc-month-year__cell--inactive")) {
                                    ...
                                    var f = o.preview.year, h = s[o.header.month];
                                    "year" === d[0] && (h = s[0]), "month" === m && (h = r), "year" === m && (f = Number(r));
                                    var p = s.findIndex((function (e) {
                                        return e.includes(h)
                                    })), y = ve(t, new Date(f, p));
                                    if (o.header.month = y.getMonth(), o.preview.year = y.getFullYear(), "year" !== d[0] && (o.header.year = y.getFullYear()), o.preview.month = y.getMonth(), "calendar" !== d[0] && (t.pickedDate = y), "calendar" !== d[0] && (o.display.setDate = y), "calendar" === d[0] && (o.calendar.setDate = y), u && o.preview.target === d[0]) return pe(t, a);
                            ...
                            var n, a = e.detail, r = a.instance, c = a.date;
                            if (r.pickedDate = c, ye(r), (null === (n = t) || void 0 === n ? void 0 : n._id) === r._id) {
                                var i = t.store;
                                i.display.setDate = c, i.calendar.setDate = i.calendar.date, "calendar" !== i.preview.target && (i.preview.month = c.getMonth(), i.preview.year = c.getFullYear(), i.preview.setTarget = i.preview.target), "month" === i.header.target && (i.header.month = c.getMonth(), i.header.year = c.getFullYear(), i.header.setTarget = i.header.target)
                            }
                        })), r.addEventListener(l, (function (n) {
                            return t && be(e, t)
                        })), document.addEventListener("click", (function (e) {
                            var n, c = e.target, i = r.contains(c),
                                o = (null === (n = t) || void 0 === n ? void 0 : n.linkedElement) === c;
                            i || o || !t || a.blur()
                        })), r.addEventListener(y, (function (e) {
                            t && (t.onCancelCallbacks.forEach((function (e) {
                                return e.apply(null)
                            })), a.close())
                            ...
                            if (n && t) {
                                n = !n;
                                var a = C(), r = t, c = r.store, i = r.viewLayers, o = r.options,
                                    l = r.onMonthChangeCallbacks, d = r.onYearChangeCallbacks, s = o.customMonths,
                                    u = e.detail.direction, v = s[c.header.month], m = c.header.year, f = me(t, v, u),
                                    h = f.newMonth, p = f.overlap, y = 0 !== p ? fe(o, m, u) : m,
                                    g = new Date(y, h.index, 1);
                                0 !== p && (E.innerHTML += Q(u, y), a.slide(E.children[0], E.children[1], u), d.forEach((function (e) {
                                    return e.apply(null)
                            ...
                            if (n && t) {
                                n = !n;
                                var a = e.detail.direction, r = t, c = r.store, i = r.viewLayers, o = r.options,
                                    l = r.onMonthChangeCallbacks, d = r.onYearChangeCallbacks, s = r.prevLimitDate,
                                    u = r.nextLimitDate, v = o.customMonths, m = C(), f = "next" === a,
                                    h = c.header.year, p = c.header.month, y = c.header.target, g = fe(o, h, a),
                                    b = null, _ = g && ve(t, new Date(g, p, 1));
                                if (g || (_ = f ? u : s), _.getMonth() !== p && (b = v[_.getMonth()]), "year" === y) {
                                    var k = c.header.year, w = f ? k + 12 : k - 12;
                            ...
                            if (t) {
                                var n = t, a = n.linkedElement, r = n.onClearCallbacks;
                                j.forEach((function (e) {
                                    return e.classList.remove("mc-date--picked")
                ...
                var se = function (e) {
                    ...
                    if (e) {
                        var n = e.pickedDate, a = e.linkedElement, r = e.onSelectCallbacks, c = e.options,
                            i = c.dateFormat, o = n ? T(n, c, i) : null;
                    ...
                    var n = e.displayDay, a = e.displayDate, r = e.displayMonth, c = e.displayYear,
                        i = e.calendarDisplay, o = t.store, l = t.options, d = o.display, s = d.target, u = d.date,
                        v = l.customWeekDays, m = l.customMonths;
                    ...
                    var n = e.currentMonthSelect, a = e.currentYearSelect, r = e.calendarHeader,
                        c = e.accessibilityMonthYear, i = t.store, o = t.options.customMonths, l = i.header,
                        d = l.target, s = l.month, u = l.year;
                    if (r.setAttribute("data-target", d), function (e, t) {
                        var n = e.monthNavPrev, a = e.monthNavNext, r = e.yearNavPrev, c = e.yearNavNext, i = t.store,
                            o = t.prevLimitDate, l = t.nextLimitDate, d = t.options, s = d.customMonths,
                            u = d.jumpToMinMax, v = i.header.target, m = i.header.month, f = i.header.year, h = j(n),
                            p = j(a), y = j(r), g = j(c);
                        ...
                        var b = me(t, s[m], "prev"), _ = me(t, s[m], "next"), k = "year" !== v && fe(d, f, "prev"),
                        ...
                        if ("calendar" === v && 0 !== b.overlap && !k && h.inactive(), "calendar" === v && 0 !== b.overlap && !k && y.inactive(), "calendar" === v && 0 !== _.overlap && !w && p.inactive(), "calendar" === v && 0 !== _.overlap && !w && g.inactive(), o) {
                            var D = new Date(f, m, 1), x = new Date(k, m + 1, 0), M = te(D, o), E = te(x, o);
                            u && M && y.inactive(), u || !E && w || y.inactive(), M && h.inactive()
                        }
                        if (l) {
                            var L = new Date(f, m + 1, 0), C = new Date(w, m, 1), T = ne(L, l), O = ne(C, l);
                            u && T && g.inactive(), u || !O && w || g.inactive(), T && p.inactive()
                        }
                    }(e, t), "year" !== d) n.innerHTML = "<span>".concat(o[s], "</span>"), a.innerHTML = "<span>".concat(u, "</span>"), c.innerText = "".concat(o[s], " ").concat(u); else {
                        var v = u;
                    ...
                    if (t) {
                        ...
                        n.setAttribute("data-target", a), n.classList.add("mc-month-year__preview--opened"), "month" == a && function (e, t) {
                            var n = e.previewCells, a = e.currentMonthSelect, r = t.store, c = t.prevLimitDate,
                                i = t.nextLimitDate, o = t.options, l = o.customMonths, d = l[r.preview.month],
                                s = r.preview.year;
                            a.setAttribute("aria-expanded", !0), l.map((function (e, t) {
                                var a = ["mc-month-year__cell"], r = new Date(Number(s), t),
                                    l = new Date(Number(s), t + 1, 0), u = c && O(l) < O(c), v = i && O(r) > O(i),
                                    m = e;
                            ...
                            var a = e.previewCells, r = e.currentYearSelect, c = t.store, i = t.prevLimitDate,
                                o = t.nextLimitDate, l = t.options, d = i && i.getFullYear(), s = o && o.getFullYear(),
                                u = c.preview.year;
                            r.setAttribute("aria-expanded", !0), a.forEach((function (e, t) {
                                var r = ["mc-month-year__cell"], c = n + t, v = i && c < d, m = o && c > s;
                    ...
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "click", a = e.store,
                        r = e.viewLayers;
                    if ("month" !== r[0]) {
                        var c = t.monthYearPreview, i = c.classList.contains("mc-month-year__preview--opened"),
                    ...
                    var n = e.calendar, a = t.store, r = t.viewLayers, c = t.options, i = t.pickedDate, o = c.bodyType,
                        l = c.theme, d = ve(t), s = d.getFullYear(), u = d.getMonth();
                    n.classList = "mc-calendar", n.classList.add("mc-calendar--".concat(o)), a.display.target = r[0], a.display.setDate = i || new Date, a.calendar.setDate = d, a.header.month = u, a.header.year = "year" === r[0] ? s - 4 : s, a.preview.month = u, a.preview.year = s, a.header.setTarget = r[0], a.preview.setTarget = r[0], function (e, t) {
                ...
                function Me(e, t, n) {
                    ...
                    var r = null !== n.el ? n.context.querySelector(n.el) : null, c = he(n), i = function (e) {
                        var t = e.minDate, n = e.maxDate, a = e.allowedYears, r = null, c = null, i = he(e), o = i[0],
                            l = i[i.length - 1], d = a.length ? Math.min.apply(Math, le(a)) : null,
                            s = a.length ? Math.max.apply(Math, le(a)) : null, u = d ? new Date(d, o.index, 1) : null,
                            v = s ? new Date(s, l.index + 1, 0) : null;
                        return t && u && (r = new Date(Math.max(t, u))), n && v && (c = new Date(Math.min(n, v))), r || (r = t || u), c || (c = n || v), {
                            prevLimitDate: r,
                            nextLimitDate: c
                        }
                    }(n), o = i.prevLimitDate, l = i.nextLimitDate, d = ue(n), s = N(t, d[0]), u = function (e, t) {
                        var n, a, r, c, i, o, l, d, s, u, v, m, f, h, p, y, g, b, _, k, w, D, x, M, E, L, C, T, O, S, Y,
                            j, N, A, P, F, V, B, q, H, W, I, $, z, J, K, U, R, X, G, Z, Q, ee, te, ne, ae, re, ce, ie,
                            oe, le;
                        return {
                            theme_color: {
                            ...
                            date_active_today_background: {
                                ...
                                color: (null == t || null === (M = t.date) || void 0 === M || null === (E = M.active) || void 0 === E || null === (L = E.today) || void 0 === L ? void 0 : L.background) || (null == t ? void 0 : t.inactive_text_color) || e.date.active.today.background
                            },
                ...
                var Ee, Le, Ce, Te = (Ee = [], Le = null, Ce = function (e) {
                    Le || (Le = oe())
                }, {
                    create: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = Z(e, c);
                        Ce();
                        var n = Me(Te, Le, t);
                        return Ee.push(n), ee(n), n
                    }, remove: function (e) {
                        var t, n = Ee.find((function (t) {
                            return t._id === e
                        }));
