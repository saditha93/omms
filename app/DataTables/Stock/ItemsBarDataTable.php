...
class ItemsBarDataTable extends DataTable
{
    /**
    ...
    public function query(Category $model)
    {
        ...
        return $barCat->items()->with(['stock', 'categories', 'measure_unit', 'establishment']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('measure_unit.name')->title("Measure Unit"),
