...
class MeasureUnitBarDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('categories', function ($item) {
                ...
                return $item->size . ' ' . $item->size_type;
            ...
            ->addColumn('action', function ($item) {
                ...
                <a href="' . route('barmeasureUnit.edit', $item->id) . '" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="bottom" title="Measure Unit Edit"><i class="fa fa-pen"></i></a>
    ...
    {
        return $model->newQuery()->with('establishment')->where('establishment_id', Auth::user()->mess_id)->whereNotNull('size_type');
    }
