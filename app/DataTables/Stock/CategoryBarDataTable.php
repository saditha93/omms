...
class CategoryBarDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($item) {
                ...
                <a href="' . route('barCategory.edit', $item->id) . '" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="bottom" title="Category Update"><i class="fa fa-pen"></i></a>
                </div>';
                } else {
                    return '<div class="w-80"></div><a href="' . route('stockCategory.show', $item->id) . '" class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="bottom" title="Category Details"><i class="fa fa-eye"></i></a>
                <a href="' . route('barCategory.edit', $item->id) . '" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="bottom" title="Category Update"><i class="fa fa-pen"></i></a>
    ...
    {
        return $model->newQuery()->with('establishment', 'parent')->where('is_bar', 1)->where('establishment_id', Auth::user()->mess_id);
    }
